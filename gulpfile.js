...
gulp.task('scripts', function() {
  ...
  function buildTemplates() {
    return gulp.src('src/**/*.html')
      ...
      .pipe(templateCache({module: 'angular-sticky-box'}));
  };

  function buildDistJS(){
    return gulp.src('src/angular-sticky-box.js')
      .pipe(plumber({
  ...
  es.merge(buildDistJS(), buildTemplates())
    ...
    .pipe(order([
      'angular-sticky-box.js',
      'template.js'
    ]))
    .pipe(concat('angular-sticky-box.js'))
...
/*
  return gulp.src('src/angular-sticky-box.less')
    .pipe(less())
    .pipe(header(config.banner, {
      timestamp: (new Date()).toISOString(), pkg: config.pkg
    }))
